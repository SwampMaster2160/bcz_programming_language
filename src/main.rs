...
use std::{env::args, ffi::c_uint, process::Command, ptr::null_mut};

use llvm_c::{LLVMAddFunction, LLVMAddGlobal, LLVMAppendBasicBlockInContext, LLVMArrayType2, LLVMBool, LLVMBuildCall2, LLVMBuildPtrToInt, LLVMBuildRet, LLVMCodeGenLevelDefault, LLVMCodeModelDefault, LLVMConstInt, LLVMConstStringInContext, LLVMContextCreate, LLVMContextDispose, LLVMCreateBuilderInContext, LLVMCreateTargetDataLayout, LLVMCreateTargetMachine, LLVMDLLImportLinkage, LLVMDisposeBuilder, LLVMDisposeModule, LLVMDumpModule, LLVMExternalLinkage, LLVMFunctionType, LLVMGetDefaultTargetTriple, LLVMGetTargetFromTriple, LLVMGetVersion, LLVMInitializeX86AsmParser, LLVMInitializeX86AsmPrinter, LLVMInitializeX86Target, LLVMInitializeX86TargetInfo, LLVMInitializeX86TargetMC, LLVMInt32TypeInContext, LLVMInt8TypeInContext, LLVMIntPtrTypeInContext, LLVMModuleCreateWithNameInContext, LLVMObjectFile, LLVMPositionBuilderAtEnd, LLVMRelocDefault, LLVMSetFunctionCallConv, LLVMSetInitializer, LLVMSetLinkage, LLVMSetModuleDataLayout, LLVMSetTarget, LLVMTargetMachineEmitToFile, LLVMTargetRef, LLVMWin64CallConv};
